          ...
          <Card sx={{ maxWidth: 345, flex: 1 }}>
            <CardActionArea component={Link} to="/audiochallenge">
              ...
              <CardContent>
                ...
                <Typography color="text.secondary">
                  Ты слышишь слово и видишь 5 вариантов его перевода. При этом
                  не видишь, как это слово пишется по-английски. Твоя задача
                  выбрать правильный перевод озвученного слова.
                </Typography>
              </CardContent>
            </CardActionArea>
          </Card>
